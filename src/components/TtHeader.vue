    ...
    <div class="nav-global">
      <div class="container">
        ...
        <ul class="nav-aside">
          <li class="nav-user">
            ...
            <div class="nav-user-wrapper">
              <div class="nav-user-list">
                ...
                <ul>
                  <li class="order"><router-link to='/orderform' >我的订单</router-link></li>
          ...
          <!--active-->
          <li class="nav-cart"
              @mouseover="$store.commit('moveDisplay')"
              @mouseout="$store.commit('outDisplay')"
          >
            <a href="javascript:;">购物车</a>
            <!--根据class改变颜色-->
            <span class="cart-empty-num " :class="{'cart-num':$store.getters.sum !== 0}" >
							<i>{{$store.getters.sum}}</i>
						</span>
            <cart v-show="$store.state.isDisplay"></cart>
          </li>
        </ul>
        <ul class="nav-list">
